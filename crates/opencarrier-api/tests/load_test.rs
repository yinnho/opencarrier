...
async fn load_spawn_kill_cycle() {
    ...
    assert_eq!(remaining, 0, "All spawned agents should be cleaned up");
}
...
async fn load_metrics_sustained() {
    ...
    for _ in 0..n {
        ...
        assert!(body.contains("opencarrier_agents_active"));
    }
