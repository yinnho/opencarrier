...
mod tests {
    ...
    fn env_var_requirement_check() {
        std::env::set_var("OPENCARRIER_TEST_HAND_REQ", "test_value");
        let req = HandRequirement {
            key: "test".to_string(),
            label: "test".to_string(),
            requirement_type: RequirementType::EnvVar,
            check_value: "OPENCARRIER_TEST_HAND_REQ".to_string(),
            description: None,
            optional: false,
            install: None,
        };
        ...
        let req_missing = HandRequirement {
            ...
            label: "test".to_string(),
            requirement_type: RequirementType::EnvVar,
            check_value: "OPENCARRIER_NONEXISTENT_VAR_12345".to_string(),
            description: None,
            optional: false,
            install: None,
        };
        assert!(!check_requirement(&req_missing));
        std::env::remove_var("OPENCARRIER_TEST_HAND_REQ");
    }
