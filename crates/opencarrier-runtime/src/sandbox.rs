...
//! # Host ABI
//!
//! The host provides (in the `"opencarrier"` import module):
...
impl WasmSandbox {
    ...
    /// Register host function imports in the linker ("opencarrier" module).
...
mod tests {
    ...
    const HOST_CALL_PROXY_WAT: &str = r#"
        (module
            (import "opencarrier" "host_call" (func $host_call (param i32 i32) (result i64)))
