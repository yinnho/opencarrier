...
impl CapabilityCheck {
    ...
    pub fn require(&self) -> Result<(), crate::error::OpenCarrierError> {
        match self {
            Self::Granted => Ok(()),
            Self::Denied(reason) => Err(crate::error::OpenCarrierError::CapabilityDenied(
                reason.clone(),
            )),
        }
    }
