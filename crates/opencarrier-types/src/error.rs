//! Shared error types for the OpenCarrier system.

use thiserror::Error;

/// Top-level error type for the OpenCarrier system.
#[derive(Error, Debug)]
pub enum OpenCarrierError {
...
/// Alias for Result with OpenCarrierError.
pub type OpenCarrierResult<T> = Result<T, OpenCarrierError>;
