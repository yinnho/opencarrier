...
pub fn default_client_ids() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("google", "opencarrier-google-client-id");
    m.insert("github", "opencarrier-github-client-id");
    m.insert("microsoft", "opencarrier-microsoft-client-id");
    m.insert("slack", "opencarrier-slack-client-id");
    m
}
...
mod tests {
    ...
    fn resolve_client_ids_uses_defaults() {
        let config = opencarrier_types::config::OAuthConfig::default();
        let ids = resolve_client_ids(&config);
        assert_eq!(ids["google"], "opencarrier-google-client-id");
        assert_eq!(ids["github"], "opencarrier-github-client-id");
    }

    #[test]
    fn resolve_client_ids_applies_overrides() {
        let config = opencarrier_types::config::OAuthConfig {
        ...
        assert_eq!(ids["github"], "opencarrier-github-client-id"); // default
        assert_eq!(ids["microsoft"], "my-msft-id");
        assert_eq!(ids["slack"], "opencarrier-slack-client-id"); // default
    }
}
