...
impl Default for MarketplaceConfig {
    fn default() -> Self {
        Self {
            ...
            github_org: "opencarrier-skills".to_string(),
        }
    }
}
    ...
    pub fn new(config: MarketplaceConfig) -> Self {
        Self {
            ...
            http: reqwest::Client::builder()
                .user_agent("opencarrier-skills/0.1")
                .build()
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.github_org, "opencarrier-skills");
    }

    #[test]
    fn test_client_creation() {
        let client = MarketplaceClient::new(MarketplaceConfig::default());
        assert_eq!(client.config.github_org, "opencarrier-skills");
    }
}
