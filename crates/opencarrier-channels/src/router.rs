...
use opencarrier_types::config::{AgentBinding, BroadcastConfig, BroadcastStrategy};
use std::sync::Mutex;
use tracing::warn;
...
mod tests {
    ...
    fn test_binding_channel_match() {
        ...
        router.load_bindings(&[AgentBinding {
            ...
            match_rule: opencarrier_types::config::BindingMatchRule {
    ...
    fn test_binding_specificity_scores() {
        use opencarrier_types::config::BindingMatchRule;
