# OpenCarrier Documentation

Welcome to the OpenCarrier documentation. OpenCarrier is the open-source Agent Operating System -- 14 Rust crates, 40 channels, 60 skills, 20 LLM providers, 76 API endpoints, and 16 security systems in a single binary.
...
opencarrier init && opencarrier start
...
| Path | Description |
|------|-------------|
| `~/.opencarrier/config.toml` | Main configuration file |
| `~/.opencarrier/data/opencarrier.db` | SQLite database |
| `~/.opencarrier/skills/` | Installed skills |
| `~/.opencarrier/daemon.json` | Daemon PID and port info |
