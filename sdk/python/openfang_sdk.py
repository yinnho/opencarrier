"""
OpenCarrier Python SDK — helper library for writing Python agents.

Usage:

    from opencarrier_sdk import Agent
...
Or for simple scripts without the decorator pattern:
    ...
    from opencarrier_sdk import read_input, respond
...
def read_input() -> Dict[str, Any]:
    """Read the input JSON from stdin (sent by the OpenCarrier kernel)."""
...
def respond(text: str, metadata: Optional[Dict[str, Any]] = None) -> None:
    """Send a response back to the OpenCarrier kernel via stdout."""
...
def log(message: str, level: str = "info") -> None:
    """Log a message to stderr (visible in OpenCarrier daemon logs)."""
...
if __name__ == "__main__":
    print("OpenCarrier Python SDK")
    print("====================")
    print()
    print("Import this module in your agent scripts:")
    print()
    print("  from opencarrier_sdk import Agent")
    print()
    print("  agent = Agent()")
    print()
